...
variable "manifest_path" {
  description = "Path to the deploy.manifest.json file"
  type        = string
}
...
variable "function_memory" {
  description = "Memory (MB) for the Cloud Function"
  type        = number
  default     = 256
}

variable "function_timeout" {
  description = "Execution timeout (seconds) for the Cloud Function"
  type        = number
  default     = 30
}
