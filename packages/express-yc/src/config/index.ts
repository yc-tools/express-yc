...
export interface LoadedExpressYcConfig {
  path?: string;
  data: Record<string, unknown>;
}

const DEFAULT_CONFIG_NAMES = [
  'express-yc.config.json',
  '.express-yc.json',
  'express-yc.config.yml',
  'express-yc.config.yaml',
];
...
export async function loadExpressYcConfig(options: {
  configPath?: string;
  projectPath?: string;
  cwd?: string;
}): Promise<LoadedExpressYcConfig> {
